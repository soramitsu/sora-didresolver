...
/**
 * Base58 is a way to encode arbitrary data as alphanumeric strings.
 * <p>
...
public class Base58 {
  ...
  public static byte[] decode(String input) throws FormatException {
    ...
    for (int i = 0; i < input.length(); ++i) {
      ...
      if (digit < 0) {
        throw new FormatException.InvalidCharacter(c, i);
      }
  ...
  public static class FormatException extends IllegalArgumentException {
    ...
    public static class InvalidCharacter extends FormatException {

      private char character;
      private int position;

      InvalidCharacter(char c, int p) {
        character = c;
        position = p;
      }
    }
